...
import main.java.pojo.InsertRecordPOJO;
...
public class InsertRecordTC extends TestBase {
	...
	public void insertSingleRecordTest() {
		...
		record = new InsertRecordPOJO(prop_singleRecord.getProperty("natid"),
				prop_singleRecord.getProperty("name"), prop_singleRecord.getProperty("gender"),
				prop_singleRecord.getProperty("salary"), prop_singleRecord.getProperty("birthday"),
				prop_singleRecord.getProperty("tax"));
